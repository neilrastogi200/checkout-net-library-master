namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _shoppingCartApiUri;
        ...
        public static string ShoppingCart
          => _shoppingCartApiUri ?? (_shoppingCartApiUri = string.Concat(AppSettings.BaseApiUri, "/products"));
